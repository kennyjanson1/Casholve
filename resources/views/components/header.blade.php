...
<header class="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
    <div class="flex items-center justify-between gap-3 sm:gap-6">
        ...
        <div class="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <div class="min-w-0">
                <h1 class="text-lg sm:text-xl md:text-2xl font-medium text-slate-900 dark:text-slate-100 truncate">{{ $currentPage['title'] }}</h1>
                <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 hidden sm:block truncate">{{ $currentPage['description'] }}</p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2 sm:gap-4 flex-shrink-0">
            ...
            >
                ...
                <svg x-show="darkMode" x-cloak class="w-5 h-5 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center gap-2 cursor-pointer">
                <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop" alt="Profile" class="w-8 h-8 sm:w-9 sm:h-9 rounded-full ring-2 ring-slate-100 dark:ring-slate-700">
                <div class="hidden lg:block">
                    <p class="text-sm font-medium text-slate-900 dark:text-slate-100">Jhonson Mick</p>
