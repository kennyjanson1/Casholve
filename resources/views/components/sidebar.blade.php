...
>
    ...
    <nav class="flex-1 space-y-1">
        ...
        <!-- Transaction - Updated to use transactions.index -->
        <a href="{{ route('transactions.index') }}" class="flex items-center gap-3 px-4 py-2 rounded-xl {{ request()->routeIs('transactions.*') || request()->routeIs('transaction') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Goals - Updated to use goals.index -->
        <a href="{{ route('goals.index') }}" class="flex items-center gap-3 px-4 py-2 rounded-xl {{ request()->routeIs('goals.*') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
